...
export default function ThaiCom() {
    const courses = [
        {
            id: 1,
            title: "Thai for Beginners",
            description: "Learn the basics of Thai with our expert instructors.",
            level: "Beginner",
            duration: "3 Week",
            image: "/assets/img/course/thai/course1.jpg",
        },
        {
            id: 2,
            title: "Thai for Intermediate",
            description: "Learn the basics of Thai with our expert instructors.",
            level: "Intermediate",
            duration: "4 Week",
            image: "/assets/img/course/thai/course2.jpg",
        },
    ];
