...
export default function Breadcrumb() {
    ...
    useEffect(() => {
        ...
        if (pathname === "/") {
            ...
            setBreadcrumb({ title: "Contact", url: "/contact", image: "/assets/img/carousel-2.jpg" });
        } else {
    ...
    return (
        <>
            {/* Render SlideHome at the top */}
            <SlideHome />

            {/* Optional: keep breadcrumb div commented out if needed */}
            {/* <div
